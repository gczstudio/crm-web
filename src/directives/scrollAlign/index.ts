...
var paddingWidth = width >= 1920 ? 16 : 12;
export const scrollalign: DirectiveOptions = {
  inserted(el:any, binding:any) {
    var dashScrollbar:Element | null = document.getElementById('dashScrollbar')
    var scrollDom:any = dashScrollbar?.firstChild;
    ...
    binding.scrollFn = function () {
      ...
      var boxHeight = scrollDom.clientHeight - paddingWidth * 2; // 中心内容区域的高度
