      ...
      <div>
        <el-row :gutter="16">
          ...
          <el-col :span="selectionType==='checkbox' ? 14 : 19">
              ...
              <!-- 查询结果表格 -->
              <yu-xtable v-if="visible" ref="mytable" row-number border row-key="userId" :data-url="dataUrl" :height="bHeight-380" @selections-change="selectionChangeFn" :base-params="dataParams" :selection-type="selectionType" :default-load="true">
