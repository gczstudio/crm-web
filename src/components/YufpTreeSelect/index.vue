<template>
  <el-popover v-model="visiable" :width="width" :visible-arrow="false" popper-class="tag-popover" :trigger="disabled ? 'manual': 'click'">
      ...
      <el-input slot="reference" ref="treeInput" v-model="searchVal" :readonly="options.readonly" :disabled="disabled" :placeholder="placeholder" suffix-icon="el-icon-arrow-down" @clear="clearFn" clearable></el-input>
  </el-popover>
</template>
