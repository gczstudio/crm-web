<template>
  <div id="tags-view-container" class="tags-view-container">
    <scroll-pane ref="scrollPane" class="tags-view-wrapper" @scroll="handleScroll" :key="visitedViews.length">
      <router-link
    ...
    <ul v-show="visible" :style="{ left: left + 'px', top: 32 + 'px' }" class="contextmenu">
