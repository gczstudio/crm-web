...
<style lang="scss">
.yufp-switch-role .el-dialog__header {
  display: none;
}
.yufp-switch-role .el-dialog__body {
  padding-bottom: 30px !important;
}
.yufp-switch-role .switch-role-title {
  color: rgba(0, 0, 0, 0.85);
  font-weight: bold;
  font-size: 16px;
}
.yufp-switch-role .switch-role-wrapper {
  margin-top: 24px;
}
.yufp-switch-role .switch-role-item {
...
.yufp-switch-role .switch-role-item:hover {
  box-shadow: 0px 2px 8px 0px rgba(200, 201, 204, 0.5);
}
.yufp-switch-role .switch-role-item:nth-child(1) {
  margin: 0;
}
.yufp-switch-role .switch-role-item img {
  width: 48px;
  height: 48px;
  border-radius: 50%;
  margin-top: 25px;
}
.yufp-switch-role .switch-role-item .sitch-role-name {
  margin: 8px 0;
  line-height: 24px;
  color: rgba(0, 0, 0, 0.85);
  font-weight: bold;
}
.yufp-switch-role .switch-role-item-content .icon-a-xuanzhongdangqian {
  color: #32d8a0;
  font-size: 24px;
}
.yufp-switch-role .sitch-role-org-name {
  margin-bottom: 16px;
}
.yufp-switch-role .icon-guanbixuanjiao {
  position: absolute;
  top: 024px;
  right: 32px;
  font-size: 24px;
