<template>
  <div class="newCreditCust-container">
    <MainLayout>
...
export default class extends Vue {
  ...
  private dataUrl = backend.custService + "/api/custchganaly/newxdcustlist";
  ...
  exportFn(showTipModal?: boolean) {
    ...
    var apiParams = {
      url: backend.custService + "/api/custchganaly/exportnewxdcust",
      params: searchQuery,
