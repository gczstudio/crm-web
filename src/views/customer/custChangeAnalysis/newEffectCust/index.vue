<template>
  <div class="newEffectCust-container">
    <MainLayout>
...
export default class extends Vue {
  ...
  private dataUrl = backend.custService + "/api/custchganaly/newvalidcustlist";
  ...
  exportFn(showTipModal?: boolean) {
    ...
    var apiParams = {
      url: backend.custService + "/api/custchganaly/exportnewvalidcust",
      params: searchQuery,
