        ...
        <template v-slot:form>
           <yu-xform ref="searchForm" :model="queryFormData" form-type="search" :search="searchFn" :need-export="true">
              <yu-xform-group :column="4">
                ...
                <yu-xform-item label="国标行业（一级）" placeholder="国标行业（一级）" ctype="select" name="natStdIndsOne" :options="natStdIndsOne"  filterable @change="natStdIndsOneChange"></yu-xform-item>
                <yu-xform-item label="国标行业（二级）" placeholder="国标行业（二级）" ctype="select" name="natStdIndsTwo" :options="natStdIndsTwo"  filterable @change="natStdIndsTwoChange"></yu-xform-item>
