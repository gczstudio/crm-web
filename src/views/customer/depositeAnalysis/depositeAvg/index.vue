        ...
        <template v-slot:form>
          <yu-xform ref="searchForm" class="search" :model="queryFormData" related-table-name="refTable" form-type="search" :need-export="true">
            <yu-xform-group :column="4">
              ...
              <yu-xform-item label="存款日均>=" :show-label-suffix="false" suffix-label="万元" suffix-label-width="28px" placeholder="存款日均" ctype="input" name="depAvg" :rules="globalRules.amountInput"></yu-xform-item>
