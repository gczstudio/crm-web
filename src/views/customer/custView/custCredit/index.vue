      ...
      <div class="yu-main-table">
        ...
        <yu-xtable v-if="queryFormData.type==='2'" key="credit" :data-url="dataUrl.credit" request-type="post" :base-params="baseParams" :dynamic-height="true" border>
          ...
          <yu-xtable-column
            ...
            :show-overflow-tooltip="true"
            width="150"
            data-code="AGREE_STATUS"
          ></yu-xtable-column>
          <yu-xtable-column
            label="授信冻结状态"
            prop="creditFrozenStatus"
            :show-overflow-tooltip="true"
            min-width="120"
            data-code="CREDIT_FROZEN_STATUS"
          ></yu-xtable-column>
          <yu-xtable-column
            label="业务品种"
            prop="bussCategory"
        ...
        <yu-xtable v-if="queryFormData.type==='5'" key="solved" :data-url="dataUrl.solved" request-type="post" :base-params="baseParams" :dynamic-height="true" border>
          ...
          <yu-xtable-column
            label="合同终结方式"
            prop="contractEndMode"
            min-width="120"
            :show-overflow-tooltip="true"
            data-code="CONTRACT_END_MODE"
          ></yu-xtable-column>
          <yu-xtable-column
            label="经办人"
            prop="apperName"
        ...
        <yu-xtable v-if="queryFormData.type==='6'" key="provide" :data-url="dataUrl.provide" request-type="post" :base-params="baseParams" :dynamic-height="true" border>
          ...
          <yu-xtable-column
            ...
            width="100"
            :show-overflow-tooltip="true"
            data-code="GUARANTEE_MODE"
          ></yu-xtable-column>
          <yu-xtable-column
            label="担保合同状态"
            prop="guaranteeContractStatus"
            width="120"
            :show-overflow-tooltip="true"
            data-code="GUARANTEE_CONTRACT_STATUS"
          ></yu-xtable-column>
          <yu-xtable-column
            label="币种"
            data-code="CURR_CD"
          ...
          <yu-xtable-column
            ...
            align="right" 
            format-money
            prop="inGuaranteeDefaultInterest"
            width="220"
            :show-overflow-tooltip="true"
          ></yu-xtable-column>
          <yu-xtable-column
            ...
            align="right" 
            format-money
            prop="onGuaranteeDefaultInterest"
            width="220"
            :show-overflow-tooltip="true"
          ></yu-xtable-column>
          <yu-xtable-column
