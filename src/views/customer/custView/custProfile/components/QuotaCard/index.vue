  ...
  <div class="quotaCard-container" :style="{ height: data.height || (data.hideLast ? '80px': '120px')}">
    <div class="top">
      ...
      <div class="total">
        ...
        <p><span class="num">{{data.unit ? $util.formatMoney(data.total) :formatMoney(data.total, data.isAmount, true)}}</span><span class="unit">{{ data.unit || (data.isAmount ? getUnit(data.total) : '')}}</span></p>
      </div>
    </div>
