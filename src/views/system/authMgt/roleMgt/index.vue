<template>
  <div class="yu-main-wrapper">
    <!-- <el-row :gutter="16">
      <el-col :span="5"> -->
        <yu-left-tree tree-key="authOrg" ref="roleTree" title="机构列表" :data-url="treeUrl" data-id="orgId" data-label="orgName"
          data-pid="upOrgId" @node-xclick="nodeClickFn" :show-checkbox="false" :expand-level='2' :highlight-current="true"
          :expand-on-click-node="true" :height="500" v-show="false"></yu-left-tree>
      <!-- </el-col>
      <el-col :span="19"> -->
        <!-- 表格工具栏 -->
        ...
        <div class="yu-main-form">
          <yu-xform class="search" :model="query" :search="queryMainGridFn" ref="query" form-type="search" label-width="120px">
            <yu-xform-group :column="4">
              ...
              <yu-xform-item label="状态" placeholder="状态" name="roleSts" ctype="select" data-code="DATA_STS">
              </yu-xform-item>
            </yu-xform-group>
          </yu-xform>
        </div>
    ...
    <yu-dialog  :title="viewTitle[viewType]" :visible.sync="dialogFormVisible" width="400px" height="350px">
        <yu-xform :model="roleForm" :disabled="formDisabled" :form-type="viewType == 'DETAIL'?'details':''" ref="roleForm" label-width="120px">
          <yu-xform-group :column="1">
            <yu-xform-item label="角色代码" :readonly="dutyCdeRead" :rules="globalRules.requiredInput50" placeholder="角色代码"
              name="roleCode" ctype="input"></yu-xform-item>
            <yu-xform-item label="角色名称" :rules="globalRules.requiredInput50" placeholder="角色名称" name="roleName" ctype="input">
            </yu-xform-item>
            <!-- <yu-xform-item label="所属机构" :params="orgIdParams" name="orgId" ctype="yufp-org-tree"></yu-xform-item> -->
            <yu-xform-item label="状态" :rules="globalRules.required" placeholder="状态" name="roleSts" ctype="select"
              data-code="DATA_STS"></yu-xform-item>
          </yu-xform-group>
        </yu-xform>
...
export default {
  ...
  methods: {
    ...
    deleteUserFn () {
      ...
      _this.$confirm('此操作将删除所选用户角色，是否继续？','提示', {
