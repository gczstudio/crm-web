          ...
          <div class="yu-main-wrapper">
            ...
            <div class="yu-main-content">
              ...
              <div class="yu-main-table">
                <yu-xtable ref="roleTable" :height="roleGrid.height" row-key="roleCode"  :highlight-current-row="true" @current-change="selectRowRole" :data-url="roleGrid.dataUrl" :base-params="roleGrid.dataParams" :default-load="true" border dynamic-height>
        ...
        <el-col :span="11">
          <div class="yu-basic-content">
            ...
            <div class="tree-container">
              <yu-ext-tree ref="menuTree" :show-checkbox="menuTree.treeCheckBox" :height="bHeight - (isMaxScreen?205:176)" :data-url="reourceUrl" data-id="id"
              data-label="menuName" v-mloading="menuTree.loading" element-loading-text="拼命加载中" node-key="id" :check-strictly="false"
              data-pid="upMenuId" :render-content="renderContent"></yu-ext-tree>
            </div>
          </div>
        </el-col>
    </el-row>
