<template>
  <div class="yu-main-wrapper">
     <!-- 表格工具栏 -->
      ...
      <el-row :gutter="6">
        <el-col :span="5">
          <yu-left-tree tree-key="authOrg" class="no-border" ref="mytree" :data-url="treeUrl" data-id="orgId" data-label="orgName" data-pid="upOrgId" @node-xclick="nodeClickFn"
            :show-checkbox="false" :expand-level='2' :highlight-current="true" :height="bHeight- (isMaxScreen?283:249)"></yu-left-tree>
    ...
    <yu-dialog  title="用户角色" :visible.sync="dialogVisibleRelInfo" height="400px" width="620px" @close="closeFn">
      <yu-xtable ref="roleTable" :height="500" :pageable="false" row-key="roleId" :data="roleData" :checkbox="true" selection-type="checkbox"
      :default-load="false" :init-selection="false" border>
