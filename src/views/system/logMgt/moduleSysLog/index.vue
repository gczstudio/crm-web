      ...
      <MainLayout>
        ...
        <template v-slot:table>
          <yu-xtable ref="refTable" :data-url="dataUrl" row-number :dynamic-height="true" border>
            ...
            <yu-xtable-column label="登录时间" prop="loginTm" is-num :show-overflow-tooltip="true" sortable="custom"></yu-xtable-column>
            <yu-xtable-column label="退出时间" prop="logoutTm" is-num :show-overflow-tooltip="true" sortable="custom"></yu-xtable-column>
