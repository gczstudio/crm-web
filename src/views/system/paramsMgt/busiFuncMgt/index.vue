              ...
              <yu-xtable ref="modTable" :data-url="modDataUrl" row-number row-key="modName" @row-dblclick="modSelect" @row-click="modSelect" :default-load="true" border dynamic-height>
                <yu-xtable-column label="模块名称" prop="modName" :show-overflow-tooltip="true">
                  <template scope="scope">
                    <a onclick="return false;" href="javascipt:void(0);" style="text-decoration: underline" @click="modRowClick(scope)">{{ scope.row.modName }}</a>
                  </template>
                </yu-xtable-column>
      ...
      <el-col :span="14">
          ...
          <div class="yu-main-content">
            ...
            <div class="yu-main-table">
              <yu-xtable ref="funcTable" :data-url="funcDataUrl" row-number selection-type="checkbox" :default-load="false" border dynamic-height>
                <yu-xtable-column label="业务功能名称" prop="funcName" :show-overflow-tooltip="true" :sortable="true" :resizable="true">
                  <template scope="scope">
                    <a onclick="return false;" href="javascipt:void(0);" style="text-decoration: underline" @click="funcRowClick(scope)">{{ scope.row.funcName }}</a>
                  </template>
                </yu-xtable-column>
                <yu-xtable-column label="URL链接" prop="funcUrl" :show-overflow-tooltip="true" :sortable="true" :resizable="true" :showOverflowTooltip="true"> </yu-xtable-column>
                <yu-xtable-column label="顺序" prop="funcOrder" :show-overflow-tooltip="true" :sortable="true" :resizable="true"> </yu-xtable-column>
        ...
        <yu-dialog :title="viewTitle[viewType]" :visible.sync="funcDialogVisible" width="800px">
          <yu-xform :model="funcForm" ref="funcForm" :disabled="funcFormDisabled" label-width="120px">
            <yu-xform-group :column="1">
              <yu-xform-item label="功能点名称" :rules="globalRules.requiredInput" name="funcName" ctype="input"> </yu-xform-item>
              <yu-xform-item label="URL链接" :rules="globalRules.required" name="funcUrl" ctype="input"> </yu-xform-item>
            </yu-xform-group>
            <yu-xform-group :column="2">
              <yu-xform-item label="图标" name="funcIcon" :rules="globalRules.required" ctype="input"> </yu-xform-item>
            ...
            <yu-xform-group :column="1">
              <yu-xform-item label="功能点描述" name="funcDesc" :rules="globalRules.desc" ctype="input" type="textarea"> </yu-xform-item>
            </yu-xform-group>
          </yu-xform>
          <div slot="footer" align="center">
