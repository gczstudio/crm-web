<template>
  <div>
    <el-row :gutter="16">
      <el-col :span="6">  
        <yu-left-tree class="box-shadow" title="菜单树" ref="menuTree" :show-checkbox="false" :height="bHeight-(isMaxScreen?232:202)" :data-url="menuTreeUrl"
          data-id="menuId" data-label="menuName" @node-xclick="nodeClickFn" data-pid="upMenuId" :filterOperateNodes="['0']" :expand-level='2' :highlight-current="true" :operates="treeOperates" :show-create="true" :create-fn="createFn">
        </yu-left-tree>
      </el-col>
      <el-col :span="7">
          ...
          <div class="yu-basic-content" :style="{height: bHeight-(isMaxScreen?166:136) + 'px'}">
            <yu-xform :model="menuForm" ref="menuForm" label-width="120px">
              <yu-xform-group :column="1">
                ...
                <yu-xform-item label="上级节点" :readonly="true" @focus="upMenuNameFocus" placeholder="请从上级菜单列表选择" :rules="globalRules.required" name="upMenuName" ctype="input"></yu-xform-item>
          ...
          <div class="yu-basic-content" :style="{height: bHeight-(isMaxScreen?166:136) + 'px', 'overflow-y': 'auto'}">
            <el-collapse v-model="expandCollapseName" accordion>
                <el-collapse-item title="业务功能列表" name="funcList">
                  ...
                  <yu-xtable ref="funcTable" :height="515" :data-url="funcUrl" @row-click="funcSelect"
                  :default-load="true">
                    <yu-xtable-column label="模块名称" prop="modName" min-width="145" :sortable="true" :resizable="true"></yu-xtable-column>
                    <yu-xtable-column label="业务功能名称" prop="funcName" min-width="150" :show-overflow-tooltip="true" :sortable="true"
                ...
                <el-collapse-item title="上层菜单" name="upMenu">
                  <yu-left-tree ref="upMenuTree" :show-checkbox="false" :height="500" :data-url="menuTreeUrl"
                      data-id="menuId" data-label="menuName" @node-xclick="upMenuClickFn" data-pid="upMenuId"
                      :data-root="{id:'0',label:'主菜单'}" :expand-level='2' :highlight-current="true">
                    </yu-left-tree>
                </el-collapse-item>
              </el-collapse>
          </div>
    ...
    saveFn: function () {
      ...
      this.$refs.menuForm.validate(function (valid) {
        if (valid) {
          ...
          if (me.addFlag || me.menuForm.menuId == undefined) { // 新增
