<template>
  <div class="commonFuns-container">
    <el-tabs class="yu-tabs">
      <el-tab-pane>
        <span slot="label"><i class="iconfont icon-changyonggongneng"></i>常用功能</span>
        <div class="func-container">
          <el-row>
            <el-col :span="6" v-for="(item, index) in commonFuncs" :key="item.menuId">
              <div class="func" @click="goPageFn(item)">
                <img :src="require(`@/assets/images/theme/${themeType}/func/func${index}.png`)" alt="" />
      ...
      <el-tab-pane>
        <span slot="label"><i class="iconfont icon-menhudaohang"></i>门户导航</span>
        <div class="func-container">
          <el-row>
            <el-col :span="6" v-for="(item, index) in portalNav" :key="item.value">
              <div class="func" @click="openNewNavFn(item)">
                <img :src="require(`@/assets/images/theme/${themeType}/nav/nav${index + 1}.png`)" alt="" />
