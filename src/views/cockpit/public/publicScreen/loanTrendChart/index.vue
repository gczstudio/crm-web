      ...
      tooltip: {
        ...
        formatter: (data: any) => {
          ...
          return `<div class="chart-tooltip">
            ...
            <p><span class="chart-dot" style="background:${params.color}"></span>${params.seriesName}：<span class="amount num">${(this as any).$util.toFixed(params.value)}</span><span class="unit">亿元</span></p>
          </div>`
        }
      },
      xAxis: {
