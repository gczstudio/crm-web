    ...
    <div class="yu-main-wrapper">
      <MainLayout>
        ...
        <template v-slot:table>
          <yu-xtable ref="refTable" :data-url="dataUrl" row-number :page-size="50" :base-params="baseParams" :dynamic-height="true" border>
            ...
            <yu-xtable-column label="公司存款余额增量（万元）" prop="corDepBalLastY" min-width="200" align="right" format-money :unit="10000" :show-overflow-tooltip="true" sortable="custom"></yu-xtable-column>
            <yu-xtable-column label="公司存款日均（万元）" prop="corDepBalAvg" min-width="180" align="right" format-money :unit="10000" :show-overflow-tooltip="true" sortable="custom"></yu-xtable-column>
            <yu-xtable-column label="公司存款日均增量（万元）" prop="corDepBalAvgLastY" min-width="200" align="right" format-money :unit="10000" :show-overflow-tooltip="true" sortable="custom"></yu-xtable-column>
            <yu-xtable-column label="公司贷款余额（万元）" prop="corLoanBal"  min-width="180" align="right" format-money :unit="10000" :show-overflow-tooltip="true" sortable="custom"></yu-xtable-column>
            <yu-xtable-column label="公司贷款余额增量（万元）" prop="corLoanBalLastY"  min-width="200" align="right" format-money :unit="10000" :show-overflow-tooltip="true" sortable="custom"></yu-xtable-column>
          </yu-xtable>
        </template>
      </MainLayout>
    </div>
