      ...
      <MainLayout>
        ...
        <template v-slot:table>
          <yu-xtable ref="refTable" :data-url="dataUrl" :page-size="50" row-number :base-params="baseParams" :dynamic-height="true" border>
            ...
            <yu-xtable-column label="小企业存款余额增量（万元）" prop="meDepBalLastY" width="240" align="right" format-money :unit="10000" :show-overflow-tooltip="true" sortable="custom"></yu-xtable-column>
            ...
            <yu-xtable-column label="小企业存款日均增量（万元）" prop="meDepBalAvgLastY" width="240" align="right" format-money :unit="10000" :show-overflow-tooltip="true" sortable="custom"></yu-xtable-column>
            ...
            <yu-xtable-column label="小微贷款余额增量（万元）" prop="meLoanBalLastY"  width="210" align="right" format-money :unit="10000" :show-overflow-tooltip="true" sortable="custom"></yu-xtable-column>
            ...
            <yu-xtable-column label="普惠贷款余额增量（万元）" prop="icLoanBalLastY"  width="210" align="right" format-money :unit="10000" :show-overflow-tooltip="true" sortable="custom"></yu-xtable-column>
            <yu-xtable-column label="小企业中间业务收入（万元）" prop="interBusIncom"  width="240" align="right" format-money :unit="10000" :show-overflow-tooltip="true" sortable="custom"></yu-xtable-column>
          </yu-xtable>
        </template>
      </MainLayout>
    </div>
