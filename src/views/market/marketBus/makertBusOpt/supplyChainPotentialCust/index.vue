<template>
  <div class="supplyChainPotentialCust-component">
    <MainLayout :title="title">
      <template v-slot:header>
        <el-button icon="el-icon-download" v-permission="'exportSupply'" @click="exportFn">导出</el-button>
      ...
      <template v-slot:table>
        <div style="padding-top: 16px;">
          <yu-xtable ref="refTable" :data-url="dataUrl" row-number selection-type="checkbox" :dynamic-height="true" border :default-load="false">
            ...
            <yu-xtable-column label="核心客户名称" prop="coreCustNm" width="250" :show-overflow-tooltip="true" sortable="custom"></yu-xtable-column>
            <yu-xtable-column label="单笔最大金额（元）" prop="maxAmt" width="200" align="right" format-money :show-overflow-tooltip="true" sortable="custom"></yu-xtable-column>
            <yu-xtable-column label="累计流入金额（元）" prop="inflowAmt" width="200" align="right" format-money :show-overflow-tooltip="true" sortable="custom"></yu-xtable-column>
