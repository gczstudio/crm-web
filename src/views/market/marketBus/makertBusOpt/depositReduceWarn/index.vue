<template>
  <div class="depositReduceWarn-component">
    <MainLayout :title="title">
      <template v-slot:header>
        <el-button icon="el-icon-download" v-permission="'exportDeposite'" @click="exportFn">导出</el-button>
      ...
      <template v-slot:table>
        <div style="padding-top: 16px">
          <yu-xtable ref="refTable" :data-url="dataUrl" row-number selection-type="checkbox" :dynamic-height="true" border :default-load="false">
            ...
            <yu-xtable-column label="上上月单月存款日均（元）" prop="lsAvgBalMon" width="250" align="right" format-money :show-overflow-tooltip="true" sortable="custom"></yu-xtable-column>
            <yu-xtable-column label="上月单月存款日均（元）" prop="avgBalMon" width="200" align="right" format-money :show-overflow-tooltip="true" sortable="custom"></yu-xtable-column>
            <yu-xtable-column label="单月存款日均降幅（%）" prop="avgBalDecline" width="200" align="right" format-money :show-overflow-tooltip="true" sortable="custom"></yu-xtable-column>
...
export default class extends Vue {
  ...
  private dataUrl = backend.mgrMkt + "/api/mkcustwrmb/querywrmb";
  ...
  mounted() {
    this.getTableData();
    this.$checkCtr("exportDeposite") && this.$exportQueue.addQueue(this.$route.path, this.exportFn, true);
  }
  ...
  exportFn(showTipModal?: boolean) {
    ...
    var apiParams = {
      url: backend.mgrMkt + "/api/mkcustwrmb/exportquerywrmb",
      params: searchQuery,
